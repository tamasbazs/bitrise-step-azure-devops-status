...
URL="https://${devops_user}:${devops_pat}@${devops_base_url}/${devops_organization}/${devops_project}/_apis/git/repositories/${devops_repository_id}/commits/${BITRISE_GIT_COMMIT}/statuses?api-version=5.1"
